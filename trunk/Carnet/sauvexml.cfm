...
<a href="sauvexml.cfm">actualiser</a>
<BR><BR>
...
<FORM ACTION="sauvexml.cfm" METHOD=POST enctype="multipart/form-data">
Envoyer un fichier XML<BR>
<input type="File" size=30 name="theFile" value=""/>
<INPUT TYPE="submit" VALUE="Envoyer le fichier XML">
</FORM>
...
<!---- LECTURE DISK ---->
<cfdirectory directory="d:/wwwroot/photos3D/uploads/" action="list" filter="*.xml" name="listfile">
<TABLE border=1>
<TR bgcolor="#c0c0c0">
<TD>Fichier XML</TD>
<TD>Size (octets)</TD>
...
<TD><cfoutput><a href="sauvexml.cfm?supimg=#name#">Supprimer</a></cfoutput></TD>
</TR> 
</cfloop>
<TABLE>
<BR>
